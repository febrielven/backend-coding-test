...
3. Run `npm install`
4. IF error install sqllite3 Run `npm install sqlite3`
5. Install eslint in global Run `npm install eslint -g`
6. Run `npm test`
7. Run `npm start`
8. Hit the server to test health `curl localhost:8010/health` and expect a `200` response 
